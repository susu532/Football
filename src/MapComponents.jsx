...
export const MAP_DATA = [
  { id: 'OceanFloor', name: 'Ocean Floor', path: '/maps_1/oceanfloor.glb', scale: 100, position: [0, 26, 0], emoji: '🌊', image: '/placeholders/Screenshots-20260105142140.png', color: '#000b1a', ambientIntensity: 0.05, lightIntensity: 0.2, fogColor: '#000b1a', fogDensity: 0.05 },
